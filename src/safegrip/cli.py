...
from .experiments import run_force_validation, run_statistical_comparison
...
def main():
    ...
    b.add_argument("--dataset",choices=["lira","synthetic"],required=True)
    ...
    t.add_argument("--dataset",choices=["lira","synthetic"],required=True)
    ...
    tb.add_argument("--dataset",choices=["lira","synthetic"],required=True)
