...
def main():
    ...
    b=sub.add_parser("benchmark"); b.add_argument("--dataset",choices=["lira","synthetic"],required=True); b.add_argument("--preset",choices=["quick","paper"],default="quick"); b.add_argument("--models",default=None,help="comma-separated cited baselines; uncited names are rejected"); b.add_argument("--proposal-hparams",default=None,help="YAML from safegrip tune; applied only to SafeGrip"); b.add_argument("--baseline-hparams",default=None,help="aggregate YAML from safegrip tune-baselines; each comparator uses its own selected settings")
